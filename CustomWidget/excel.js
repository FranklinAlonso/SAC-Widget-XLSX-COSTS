(function() {
    ...
    class Excel extends HTMLElement {
        ...
        onCustomWidgetAfterUpdate(changedProperties) {
            ...
            let xlsxjs = "https://franklinalonso.github.io/SAC-Widget-XLSX-COSTS/CustomWidget/xlsx.js";
    ...
    customElements.define("com-frank-dlc-sap-sac-excel", Excel);
                          ...
                          if (rec.length > 0) {
                            ...
                            if (len > 0) {
                              ...
                              result_final.push({
                                ...
                                'PLAZA': rec[2].trim(),
                                'TERRENO': rec[3].trim(),
                                'TIPO_DE_PRODUCTO': rec[4].trim(),
                                'SUBTIPO': rec[5].trim(),
                                'MONEDA': rec[6].trim(),
                                'TIPO_PERFIL': rec[7].trim(),
                                'PROYECTO': rec[8].trim(),
